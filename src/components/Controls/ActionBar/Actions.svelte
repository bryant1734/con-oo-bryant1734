<script>
	...
	$: canUseHint = !$keyboardDisabled && hintsAvailable && hasCursor && selectedValue === 0;
...
<div class="action-buttons space-x-3">
	...
	<button class="btn btn-round btn-badge" disabled={!canUseHint} on:click={handleHint} title="Hints ({$hints})">
		<svg class="icon-outline" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
